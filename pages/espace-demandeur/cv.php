                            ...
                            <?php
                             echo $donnees['description'];
                              echo "<hr/>";
                                ...
                                echo "<p>"."<a href='editer-cv.php?id_demandeur=".$donnees['id_demandeur']."&id_cv=".$donnees['id_cv']."' class='btn btn-warning' role='button'>".'Modifier'."</a>"."<a href='traitements.php?id_demandeur=".$donnees['id_demandeur']."&id_cv=".$donnees['id_cv']."' class='btn btn-danger pull-right' role='button'>".'Supprimer'."</a>"."</p>";
                                echo "</div>";  
                            ?>
                          </div>
                        </div>
