                      ...
                      <form role="form" method="POST" action="traitements.php?id_employeur=<?php echo $_SESSION['id_employeur']; ?>&id_offre=<?php echo $_GET['id_offre']; ?>">
                        <div class="form-group">
                          <div style="margin-bottom: 25px" class="input-group">
                            ...
                            <input type="text" class="form-control" name="intituleOffre" placeholder="Intitulé de l'offre" value="<?php echo $infosEmployeur['intitule']; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <div style="margin-bottom: 25px" class="  input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-education"></i></span>
                            <input type="text" class="form-control" name="qualificationRequise" placeholder="Qualification requise" value="<?php echo $infosEmployeur['qualification_requise']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div style="margin-bottom: 25px" class="  input-group">
                            ...
                            <input type="text" class="form-control" name="datePublication" placeholder="Date de publication" value="<?php echo $infosEmployeur['date_publication']; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <div style="margin-bottom: 25px" class="  input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-remove  "></i></span>
                            <input type="text" class="form-control" name="dateLimite" placeholder="Date limite" value="<?php echo $infosEmployeur['date_limite']; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <div style="margin-bottom: 25px" class="  input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-home  "></i></span>
                            <input type="text" class="form-control" name="lieuDepot" placeholder="Lieu de dépôt" value="<?php echo $infosEmployeur['lieu_depot']; ?>">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="comment">Commentaire:</label>
                          <textarea class="form-control" rows="5" id="comment" name="commentaire"><?php echo $infosEmployeur['commentaire']; ?></textarea>
                        </div>
