                            ...
                            echo "<div class='modal-dialog'>";
                              echo "<div class='modal-content'>";
                                ...
                                echo "<div class='modal-body'>";
                                    ...
                                    echo "<hr/>";
                                    echo "<p>"."<a href='modifier-offres.php?id_employeur=".$_SESSION['id_employeur']."&id_offre=".$donnees['id_offre']."' class='btn btn-warning' role='button'>".'Modifier'."</a>"."<a href='traitement.php?id_employeur=id_offre=".$donnees['id_offre']."' class='btn btn-danger pull-right' role='button'>".'Supprimer'."</a>"."</p>";
                                echo "</div>";
                              echo "</div>";
                            echo "</div>";
                           echo "</div>";
